...
// caller
import { postArticle } from "@/Helpers/callers";
                ...
                <div className="grid gap-4 mb-4 grid-cols-2">
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      name="title"
                      id="title"
                      className="bg-gray-50 border border-gray-300 text-gray-900 font-semibold text-sm rounded-lg block w-full p-2.5"
