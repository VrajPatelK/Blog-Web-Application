        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center items-center sm:mt-0">
              <Link
                href="#"
                className="text-gray-500 hover:text-gray-900 bg-orange-500 px-3 w-8 h-8 flex rounded-full"
              >
                <svg
              ...
              <Link
                href="#"
                className="text-gray-500 hover:text-gray-900 ms-5 p-2 rounded-full"
              >
                <svg
